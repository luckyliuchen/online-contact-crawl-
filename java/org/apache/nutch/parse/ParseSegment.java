...
public class ParseSegment extends Configured implements Tool,
  ...
  public void configure(JobConf job) {
    ...
    LOG.info("ParseSegment configure input path = " + FileInputFormat.getInputPaths(job)[0].toString() );
    LOG.info("ParseSegment configure out path = " + FileOutputFormat.getOutputPath(job).toString() );
  ...
  public void map(WritableComparable key, Content content,
    ...
    for (Entry<Text, Parse> entry : parseResult) {
      ...
      LOG.info( " ParseSegment map url = " + url + " ; parse.getText() = " + parse.getText() + " ; parse.getData() = " + parse.getData()  );
