...
class ReduceTask extends Task {
  ...
  void runOldReducer(JobConf job,
    ...
    try {
      ...
      LOG.info(" ReduceTask run reducer = " + reducer.toString() );
      while (values.more()) {
        reduceInputKeyCounter.increment(1);
        LOG.info(" ReduceTask run values.getKey() = " + values.getKey().toString() + " ; values = " + values.toString() + " ; collector = " + collector.toString() );
