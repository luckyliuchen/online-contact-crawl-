...
public abstract class FileOutputFormat<K, V> implements OutputFormat<K, V> {
	  public static final Logger LOG = LoggerFactory.getLogger(FileOutputFormat.class);
  ...
  public void checkOutputSpecs(FileSystem ignored, JobConf job) 
    ...
    LOG.info("FileOutputFormat  checkOutputSpecs outDir 111 = " + outDir.toString());
    ...
    if (outDir != null) {
      ...
      LOG.info("FileOutputFormat  checkOutputSpecs outDir 2222 = " + outDir.toString());
